...
public class Main {
    public static void main(String[] args) {
        ...
        while(!response.equals("done")) {
            ...
            int keyFind1 = 1697432123;
            int keyFind2 = 1073741789;
            int n = keyFind1 * keyFind2;
            BigInteger e = new BigInteger("16788"); // must be relatively prime to (keyFind1 - 1)(keyFind2 - 1)
            BigInteger d = new BigInteger("2783747551723989965");
